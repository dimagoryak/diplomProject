  ...
  render = () => (
    ...
    >
      <Button className="board-deleter-button">
        ...
        <div className="board-header-right-text">&nbsp;Видалити дошку</div>
      </Button>
      <Menu className="board-deleter-menu">
        <div className="board-deleter-header">Ви впевнені?</div>
        <MenuItem className="board-deleter-confirm">Видалити</MenuItem>
      </Menu>
    </Wrapper>
  );
}
